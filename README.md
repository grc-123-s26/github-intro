...
1. Open the `README.md` file. Make any change to it (adding your name, writing a poem, fixing a typo you found, etc... or in this case adding some text here to demonstrate a change was made :) )
